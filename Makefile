...
# sail.codes/pecan-operator-bundle:$VERSION and sail.codes/pecan-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= sail.codes/pecan-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.28.0/ansible-operator_$(OS)_$(ARCH) ;\
